...
import Ray from "cesium/Core/Ray.js";
...
import SphereGeometry from "cesium/Core/SphereGeometry.js";
...
import Quaternion from "cesium/Core/Quaternion.js";
import ArrowPolyline from "./LineAxis.js";
import AxisSphere from "./SphereAxis.js";
...
class TransformationController {
   ...
   * 创建控制器。
   *
   * @param {Cesiu.Viewer} viewer 三维地图容器。
   */
  constructor(viewer) {
    this.viewer = viewer;
   ...
   * @param {Cesium.Model} model 添加控制器的模型
   */
  add(model) {
    this.model = model;
