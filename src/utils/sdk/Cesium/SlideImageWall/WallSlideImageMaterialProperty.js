...
import "./WallSlideImageMaterial.js";

class WallSlideImageMaterialProperty {
  constructor(options = {}) {
  ...
  getType() {
    return Material.WallSlideImageType;
  }
  ...
  equals(other) {
    return (
      this === other ||
      (other instanceof WallSlideImageMaterialProperty &&
...
Object.defineProperties(WallSlideImageMaterialProperty.prototype, {
...
export default WallSlideImageMaterialProperty;
