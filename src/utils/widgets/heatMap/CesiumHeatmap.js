...
class HeatLayer{
	...
	_redraw() {
		...
		// this._entity.rectangle.material = new Color(1.0,1.0,1.0,0.0)
		// this._entity = this._nextEntity
		setTimeout(function(){
			// that._entity.rectangle.material = new Color(1.0,1.0,1.0,0.0)
			that._entity.show = false
			that._entity = that._nextEntity
			that._nextEntity
