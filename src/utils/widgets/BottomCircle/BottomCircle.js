...
class BottomCircle {
    ...
    constructor(options) {
        ...
        let position = (options && options.position) || new THREE.Vector3(0,0,-0.01)
        ...
        let o = Object.assign(triangleOptions, {color: new THREE.Color('rgb(68,215,166)'), start:0.5})
        console.log(o)
    ...
    createRing() {
        ...
        const material = new THREE.MeshBasicMaterial( { color: new THREE.Color('rgb(86, 191, 164)'), side: THREE.DoubleSide, transparent:true, opacity: 0.8 } )
    ...
    createSplitRing() {
        ...
        const material1 = new THREE.MeshBasicMaterial( { color: new THREE.Color('rgb(255, 255, 254)'), side: THREE.DoubleSide, transparent:true, opacity: 0.2 } )
        const geometry2 = new THREE.RingGeometry( 38, 31, 120, 8, w+int, w )
        const material2 = new THREE.MeshBasicMaterial( { color: new THREE.Color('rgb(255, 255, 254)'), side: THREE.DoubleSide, transparent:true, opacity: 0.2 } )
        const geometry3 = new THREE.RingGeometry( 38, 31, 120, 8, 2*(w+int), w )
        const material3 = new THREE.MeshBasicMaterial( { color: new THREE.Color('rgb(255, 255, 254)'), side: THREE.DoubleSide, transparent:true, opacity: 0.2 } )
    ...
    createArc() {
        const geometry = new THREE.RingGeometry( 41.2, 40.4, 84, 8, 0, 2*Math.PI/35)
        const material = new THREE.MeshBasicMaterial( { color: new THREE.Color('rgb(249, 232, 98)'), side: THREE.DoubleSide, transparent:true, opacity: 0.8 } )
