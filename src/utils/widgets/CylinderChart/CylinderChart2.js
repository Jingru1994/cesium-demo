...
class CylinderChart {
    ...
    openPopup() {
        ...
        this.isPopup = true
        labelRenderer.domElement.addEventListener('mousemove',function _listener(e) {
            onPointerMove(e)
            if(!that.isPopup) {
        ...
        function onPointerMove(event) {
            ...
            if(intersects.length > 0) {
                if(!selectedObject || selectedObject !== intersects[0].object) {
                    ...
                    popup.addTo(selectedObject).setHtml(selectedObject.html).setOffset(that.legendOffset)
                }
            }else {
                if(selectedObject) {
