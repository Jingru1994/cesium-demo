...
class DivGraphic {
    ...
    */
    async addTo(viewer) {
        ...
        const divPosition = await DivGraphic.getHeight(inPosition, heightType, viewer);
    ...
    static getOffset(element, options) {
        ...
        const verticalReference = options.verticalReference || VerticalReference.BOTTOM;
        const horizontalReference = options.horizontalReference || HorizontalReference.LEFT;
