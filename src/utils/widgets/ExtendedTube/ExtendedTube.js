...
class ExtendedTube {
    ...
    createOuterTube(params) {
        ...
        const geometry = new THREE.TubeGeometry(curve1, tubularSegments, radius, 8, false);
    ...
    extendTube() {
        ...
        if(this.speedDown % this.speedDownScale === 0){ 
            ...
            if(this.pointList.length > 2){
                ...
                const geometry = new THREE.TubeGeometry(curve, this.tubularSegments, this.outerRadius, 8, false);
