...
export default class TranslationController {
    ...
    // 添加监听器
    _addListener () {
        this.handler.setInputAction(this._clickListener,Cesium.ScreenSpaceEventType.LEFT_DOWN)
        this.handler.setInputAction(this._clickUpListener,Cesium.ScreenSpaceEventType.LEFT_UP)
        this.handler.setInputAction(this._moveListener,Cesium.ScreenSpaceEventType.MOUSE_MOVE)
    }
    ...
    translation (moveVector, unit, moveLength) {
        ...
        this.axisX.translation(moveVector, Cesium.Matrix3.multiplyByVector(mX, unit, new Cesium.Cartesian3()), moveLength)
        this.axisY.translation(moveVector, Cesium.Matrix3.multiplyByVector(mY, unit, new Cesium.Cartesian3()), moveLength)
        ...
        this.axisSphereX.translation(moveVector, Cesium.Matrix3.multiplyByVector(mX, unit, new Cesium.Cartesian3()), moveLength)
        this.axisSphereY.translation(moveVector, Cesium.Matrix3.multiplyByVector(mY, unit, new Cesium.Cartesian3()), moveLength)
    ...
    _rotateVectorByAxisForAngle(vector, axis, angle){
        const rotateQuaternion = this.normalizingQuaternion(Cesium.Quaternion.fromAxisAngle(axis, angle, new Cesium.Quaternion()))
    ...
    getPlanePosition (position, cameraPosition, pickRay, axisDirection) {
        // 第一步, 获取相机在轴上的投影
        const cartesian3 = Cesium.Cartesian3.subtract(cameraPosition, position, new Cesium.Cartesian3())//c1 相机位置到模型位置向量
        ...
        const pn = Cesium.Cartesian3.subtract(cameraPosition, cartesian3, new Cesium.Cartesian3())//相机位置与     
        // 获取单位向量, 射线向投影向量投影
        ...
        Cesium.Cartesian3.multiplyByScalar(pickRay.direction, -number1/number, cartesian3);//c5
        return cartesian3
    }
    ...
    getPlaneRotationPosition (position, cameraPosition, pickRay, axisDirection) {
        const cartesian3 = Cesium.Cartesian3.subtract(cameraPosition, position, new Cesium.Cartesian3())//c1
        ...
        Cesium.Cartesian3.multiplyByScalar(pickRay.direction, -length / number, cartesian3);//c2
