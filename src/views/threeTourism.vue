...
export default {
  ...
  methods: {
    ...
    addMark() {
      const pointList = [
        new THREE.Vector3(25, 6.6, -20),
        new THREE.Vector3(-10, 6.6, 6),
        new THREE.Vector3(-15, 6.6, 37)
      ];
    ...
    addGroundElements() {
      ...
      const outCircleTexture = new THREE.TextureLoader().load(
        "images/tourism/outCircle.png"
      );
      ...
      const inCircleTexture = new THREE.TextureLoader().load(
        "images/tourism/inCircle.png"
      );
    ...
    drawExtrude(shapeObj) {
      ...
      const diffiseTexture = new THREE.TextureLoader().load(
        "images/rs/beijing_satellite.png"
      );
      ...
      let shapeGeometryObj = new THREE.Mesh(geometry, [
        terrainMaterial,
        material2
      ]);
