...
import PatternShield from '@/utils/widgets/PatternShield/PatternShield.js'
import GlowShield from '@/utils/widgets/GlowShield/GlowShield.js'
...
export default ({
    ...
    methods: {
        ...
        createGlowShield() {
            let options = {
                center: new THREE.Vector3(0, 0, this.depth),
                radius: 5,
            ...
            let options1 = {
                center: new THREE.Vector3(25, -10, this.depth),
                radius: 5,
                color: new THREE.Color('rgb(85,187,237)')
            }
            let glowShield = new GlowShield(options1)
            glowShield.mesh.renderOrder = 10
