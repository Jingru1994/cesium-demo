...
export default {
    ...
    data() {
        return {
            ...
            photogrammetryUrl: "http://192.168.40.26/file/3dtiles/tileset.json",
    ...
    mounted() {
        ...
        this.viewer.scene.globe.baseColor = Cesium.Color.fromBytes(112, 128, 144, 255);//设置地球颜色
        // this.initCamera()
    },
    beforeDestroy() {},
    computed: {
    ...
    methods: {
        ...
        zoomToTiles(tileset){
            ...
            let surface = Cesium.Cartesian3.fromRadians(cartographic.longitude, cartographic.latitude, 193.0);//倾斜数据中心点的笛卡尔坐标 
            let offset =Cesium.Cartesian3.fromRadians(cartographic.longitude, cartographic.latitude, 0.0);//带高程的新笛卡尔坐标
            let translation = Cesium.Cartesian3.subtract(offset, surface, new Cesium.Cartesian3());
            tileset.modelMatrix = Cesium.Matrix4.fromTranslation(translation);

            this.viewer.zoomTo(tileset, new Cesium.HeadingPitchRange(0.0, -0.5, tileset.boundingSphere.radius * 2));
