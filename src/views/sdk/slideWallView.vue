<template>
  <div id="cesiumContainer" class="cesium-container slide-wall"></div>
</template>

<script>
import MyViewer from "@/utils/sdk/Cesium/MyViewer/MyViewer.js";
import SlideImageWall from "@/utils/sdk/Cesium/SlideImageWall/SlideImageWall.js";
...
export default {
  ...
  methods: {
    ...
    async addFlowLine() {
      ...
      const slideWallOptions = {
        positions: wallEdgeData,
        height: 200,
        color: "rgb(255, 255, 255)",
        speed: 1
      };
      let slideWall = new SlideImageWall(slideWallOptions);
      slideWall.addTo(this.viewer);
    }
  }
};
</script>
