...
import ScanCircle from "@/utils/sdk/Three/ScanCircle/ScanCircle.js";
...
export default {
  ...
  methods: {
    ...
    async createScanCircle() {
      ...
      scanCircle.mesh.position.z = 2.1;
